<section id="inscription">
	...
	<form action="users/register" method="post" id="inscription-form">
		...
		<div class="form-group" >
			...
			<input type="text" class="form-control" id="pseudo" aria-describedby="pseudoHelp" placeholder="Saisir votre pseudo" name="pseudo" minlength="3" maxlength="12">
			<small id="pseudoHelp" class="form-text text-muted">3 à 12 caractères; Caractères alphanumériques uniquement.</small>
		</div>		
		<div class="form-group">
			<label for="mail">Adresse email</label>
			<input type="email" class="form-control" id="mail" aria-describedby="emailHelp" placeholder="Saisir votre Email" name="mail">
		...
		<div class="form-group">
			...
			<input type="password" class="form-control" id="pass2" name="pass2" placeholder="Resaisir votre mot de passe" aria-describedby="pass2Help">
