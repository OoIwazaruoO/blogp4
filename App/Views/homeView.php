<section id="homePresentation">
	...
	<blockquote class="blockquote text-center">
		<p class="mb-0"><< S'il te plait, code moi un blog. >></p>
		<footer class="blockquote-footer">Le petit Jean <cite title="Source Title"> Mes passions</cite></footer>
	</blockquote>
	<a href="/articles" ><button type="button" class="btn btn-primary">Accéder au blog n° infini²</button></a>
</section>
